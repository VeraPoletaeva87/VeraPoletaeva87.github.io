...
class App extends React.Component {
  ...
  render() {
    ...
    return (
      <div className='App'>
        {/* TODO: переместить хэдер в отдельный компонент */}
        <header>
            ...
            <div>
              <div className='currentQuestion flex'>
                ...
                <div className='currentBirdBlock'>
                  ...
                  <div>
                    <audio className='audio' controls ref={this.questionAudio} src={voice}>
                  ...
                  {clickedBirds.length !== 0 || guessed ?
                    <div className='clickedBirdInfo'>
                      <div className='flex'>
                        ...
                        <div className='currentBirdBlock'>
                          <div className='whiteText lastClikedName'>{guessed ? currentName : lastClicked}</div>
                          <div className='whiteText currentBirdLatName'>{lastClickedInfo.latName}</div>
                          <div>
                            <audio className='audio' controls src={lastClickedInfo.voice}/>
                          </div>
                        </div>
                      </div>
                      <div className='padding15'>{lastClickedInfo.description}</div>
